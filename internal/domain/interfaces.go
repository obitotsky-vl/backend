...
type BookingRepository interface {
	BookSlot(ctx context.Context, slotID, userID uuid.UUID, meta json.RawMessage) (*Booking, error)
	GetAvailableSlots(ctx context.Context, branchID uuid.UUID) ([]Slot, error)
}
